...
[PSR-1]: https://github.com/httpool/fig-standards/blob/master/accepted/PSR-1-basic-coding-standard.md
...
Code MUST use an indent of 1 tab, and MUST NOT use 4 spaces for indenting.
...
When present, there MUST be one blank line before and after the `namespace` declaration.
